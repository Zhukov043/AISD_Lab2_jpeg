...
is_luma = True
luma_ac = split_ac(h_blocks, w_blocks, decode_ac_coefficients(luma_ac, is_luma))
is_luma = False
cb_ac = split_ac(h_blocks_chr, w_blocks_chr, decode_ac_coefficients(cb_ac, is_luma))
cr_ac = split_ac(h_blocks_chr, w_blocks_chr, decode_ac_coefficients(cr_ac, is_luma))

#Восстановление блоков
is_luma = True
luma_ch = restore_image(luma_dc, luma_ac, h_blocks, w_blocks, N, is_luma, quality, height * 2, width * 2)
is_luma = False
cb_ch = restore_image(cb_dc, cb_ac, h_blocks_chr, w_blocks_chr, N, is_luma, quality, height, width)
cr_ch = restore_image(cr_dc, cr_ac, h_blocks_chr, w_blocks_chr, N, is_luma, quality, height, width)
...
Image.fromarray(rgb_restored).save("Restored_image.png")
